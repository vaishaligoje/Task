...
exports.config = {
  ...
  cucumberOpts: {
    ...
    // format: [
    //   "json:./reports/cucumber/json/cucumber_report.json", // Path for JSON output
    // ],
  ...
  //   before: async () => {
  //     // await browser.url(data.landingPage);
  ...
  //     // default = '.tmp/json/'
  //     jsonDir: "./reports/cucumber/json/",
  //     reportPath: "./reports/cucumber/cucumberReport/",
